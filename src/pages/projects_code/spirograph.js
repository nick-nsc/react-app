...
export default class Spirograph extends React.Component {
    constructor(props) {
        ...
        this.traceonoff_handleClick = this.traceonoff_handleClick.bind(this);
    ...
    SketchCode = (p) => {
        ...
        */
        ...
        let trace = this.state.trace; // are we tracing?
    ...
    render() {
        return(
            <main style={{ 'marginLeft': '15%' }}>
                ...
                <button name="traceonoff" onClick={this.traceonoff_handleClick}>
                    Toggle Trace
                </button>
            </main>
        )
